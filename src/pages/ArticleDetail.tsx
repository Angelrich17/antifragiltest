...
const ArticleDetail = () => {
  ...
  const articles = {
    ...
    "comprar-vivienda-buenos-aires-bitcoin": {
      ...
      ` : '<div class="space-y-8"><div class="bg-gradient-to-r from-blue-50 to-green-50 border-l-4 border-blue-500 p-6 rounded-r-lg"><p class="text-sm text-blue-700 font-medium mb-2">🏢 Updated: January 13, 2025 | Argentina new economic cycle</p></div><h2 class="text-2xl font-bold text-slate-800 flex items-center gap-3 mt-8 mb-4">Starting point: Argentina new cycle</h2><p class="text-lg leading-relaxed text-slate-700 mb-6">Since Javier Milei took office in December 2023, Argentina eliminated the primary fiscal deficit and stabilized the exchange rate. The result is twofold: real wages in USD nearly tripled, and banks resumed mortgage lending in hard currency.</p><h2 class="text-2xl font-bold text-slate-800 flex items-center gap-3 mt-12 mb-6">🏆 Verdict: 2025 standout winner</h2><div class="bg-gradient-to-r from-green-50 to-emerald-50 border-2 border-green-300 rounded-xl p-8 mb-8"><h3 class="text-xl font-bold text-green-800 mb-4">🌟 Absolute winner: Office reconversion in Microcentro</h3><p class="text-green-700">Low entry barriers: US$1,200/m² | Market-leading yield: 8–10% gross | Appreciation potential: 100%+ | Inflation hedge: USD-indexed rent</p></div></div>'
          <!-- Highlighted Intro -->
          <div class="bg-gradient-to-r from-blue-50 to-green-50 border-l-4 border-blue-500 p-6 rounded-r-lg">
          ...
          <div class="space-y-4 mb-8">
            <div class="bg-gradient-to-r from-purple-50 to-purple-100 border border-purple-200 rounded-lg p-4">
              <h3 class="font-bold text-purple-800 mb-2">Puerto Madero</h3>
              <p class="text-purple-700 font-bold text-lg">~US$6,000/m²</p>
              <p class="text-purple-600 text-sm">Ultra-modern waterfront with new towers and river views.</p>
            </div>
            
            <div class="bg-gradient-to-r from-indigo-50 to-indigo-100 border border-indigo-200 rounded-lg p-4">
              <h3 class="font-bold text-indigo-800 mb-2">Palermo Chico</h3>
              <p class="text-indigo-700 font-bold text-lg">~US$4,000/m²</p>
              <p class="text-indigo-600 text-sm">Embassy quarter with palaces and parks.</p>
            </div>
            ...
            <table class="w-full bg-white">
              ...
              <tbody class="divide-y divide-slate-200">
                <tr class="hover:bg-purple-50 transition-colors">
                  <td class="px-6 py-4 font-medium text-purple-800">Puerto Madero</td>
                  <td class="px-6 py-4 text-purple-700 font-bold">~US$6,000/m²</td>
                  <td class="px-6 py-4 text-slate-600">Ultra-modern waterfront with new towers and river views</td>
                </tr>
                <tr class="hover:bg-indigo-50 transition-colors">
                  <td class="px-6 py-4 font-medium text-indigo-800">Palermo Chico</td>
                  <td class="px-6 py-4 text-indigo-700 font-bold">~US$4,000/m²</td>
                  <td class="px-6 py-4 text-slate-600">Embassy quarter with palaces and parks</td>
                </tr>
                <tr class="hover:bg-blue-50 transition-colors">
                  <td class="px-6 py-4 font-medium text-blue-800">Palermo Soho/Hollywood & Núñez</td>
                  <td class="px-6 py-4 text-blue-700 font-bold">~US$3,000/m²</td>
                  <td class="px-6 py-4 text-slate-600">Gastronomic hub and nightlife</td>
                </tr>
                <tr class="hover:bg-green-50 transition-colors">
                  <td class="px-6 py-4 font-medium text-green-800">Recoleta</td>
                  <td class="px-6 py-4 text-green-700 font-bold">~US$2,700/m²</td>
                ...
                <tr class="hover:bg-amber-50 transition-colors border-2 border-amber-300">
                  <td class="px-6 py-4 font-bold text-amber-800">🌟 Microcentro</td>
                  <td class="px-6 py-4 text-amber-700 font-bold text-lg">US$1,000-1,500/m²</td>
                  <td class="px-6 py-4 text-amber-600 font-medium">Massive inventory at fire-sale prices</td>
                </tr>
              </tbody>
            </table>
          </div>
          ...
          <div class="space-y-4 mb-8">
            <div class="bg-red-50 border border-red-200 rounded-lg p-4">
              <h3 class="font-bold text-red-800 mb-2">Madrid Centro</h3>
              <p class="text-red-700 font-bold text-lg">€4,500/m² (~US$4,700/m²)</p>
              <p class="text-red-600 text-sm">Gross yield: 3.5% | Appreciation: 15-20%</p>
            </div>
            
            <div class="bg-orange-50 border border-orange-200 rounded-lg p-4">
              <h3 class="font-bold text-orange-800 mb-2">Barcelona Eixample</h3>
              <p class="text-orange-700 font-bold text-lg">€3,800/m² (~US$3,970/m²)</p>
              <p class="text-orange-600 text-sm">Gross yield: 4% | Appreciation: 20-25%</p>
            </div>
            
            <div class="bg-green-50 border-2 border-green-300 rounded-lg p-4 shadow-md">
              <h3 class="font-bold text-green-800 mb-2">🏆 Buenos Aires Microcentro</h3>
              <p class="text-green-700 font-bold text-xl">US$1,200/m²</p>
              <p class="text-green-600 font-medium">Gross yield: 8% | Appreciation: 100%+</p>
            </div>
          </div>
          \` : \`
          <div class="overflow-x-auto shadow-lg rounded-lg mb-8">
            <table class="w-full bg-white">
              <thead class="bg-gradient-to-r from-slate-700 to-slate-800 text-white">
                <tr>
                  <th class="px-6 py-4 text-left font-semibold">City/Zone</th>
                  <th class="px-6 py-4 text-left font-semibold">Price/m²</th>
                  <th class="px-6 py-4 text-left font-semibold">Gross Yield</th>
                  <th class="px-6 py-4 text-left font-semibold">Appreciation Potential</th>
                </tr>
              </thead>
              <tbody class="divide-y divide-slate-200">
                <tr class="hover:bg-red-50 transition-colors">
                  <td class="px-6 py-4 font-medium text-red-800">Madrid Centro</td>
                  <td class="px-6 py-4 text-red-700 font-bold">€4,500/m² (~US$4,700/m²)</td>
                  <td class="px-6 py-4 text-red-600">3.5%</td>
                  <td class="px-6 py-4 text-red-600">15-20%</td>
                </tr>
                <tr class="hover:bg-orange-50 transition-colors">
                  <td class="px-6 py-4 font-medium text-orange-800">Barcelona Eixample</td>
                  <td class="px-6 py-4 text-orange-700 font-bold">€3,800/m² (~US$3,970/m²)</td>
                  <td class="px-6 py-4 text-orange-600">4%</td>
                  <td class="px-6 py-4 text-orange-600">20-25%</td>
                </tr>
                <tr class="hover:bg-green-50 transition-colors border-2 border-green-300">
                  <td class="px-6 py-4 font-bold text-green-800">🏆 Buenos Aires Microcentro</td>
                  <td class="px-6 py-4 text-green-700 font-bold text-lg">US$1,200/m²</td>
                  <td class="px-6 py-4 text-green-600 font-bold text-lg">8%</td>
                  <td class="px-6 py-4 text-green-600 font-bold text-lg">100%+</td>
                </tr>
              </tbody>
            </table>
          </div>
          ...
          <div class="bg-slate-50 border border-slate-200 rounded-xl p-8">
            ...
            <div class="mt-8">
              <div class="w-full bg-gradient-to-r from-blue-600 to-green-600 hover:from-blue-700 hover:to-green-700 text-white font-bold py-4 px-6 rounded-lg text-center cursor-pointer text-lg">
                💼 Ready to invest
              </div>
